            ...
            flex: 4,
              child: Container(
                ...
                child: SfDateRangePicker(
                  ...
                  monthCellStyle: const DateRangePickerMonthCellStyle(textStyle: TextStyle(color: Colors.blue)),
                  yearCellStyle: const DateRangePickerYearCellStyle(textStyle: TextStyle(color: Colors.blue)),
                  headerHeight: 75,
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Container(
                    ...
                    child: GFCard(
                      ...
                      title: GFListTile(
                        title: Text(projects[index]['name'], style: TextStyle(fontWeight: FontWeight.bold),),
                        subTitleText: '2024-07-22\n'+projects[index]['description'],
                        icon: InkWell(
                          child: Icon(
                            Icons.info,
                            color: GFColors.DARK,
